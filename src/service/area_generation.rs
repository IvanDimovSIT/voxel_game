...
use crate::model::{area::{Area, AreaLocation, AREA_HEIGHT, AREA_SIZE}, location::InternalLocation};
...
pub fn generate_area(area_location: AreaLocation) -> Area {
    ...
    for x in 0..AREA_SIZE {
        for y in 0..AREA_SIZE {
            area.set(InternalLocation::new(x, y, AREA_HEIGHT-1), crate::model::voxel::Voxel::Stone);
        }
    }
