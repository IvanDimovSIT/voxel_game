...
mod tests {
    ...
    #[test]
    fn test_add_item_into_same_stack() {
        let mut inventory = Inventory::default();
    ...
    #[test]
    fn test_add_item_into_prexisting() {
        let mut inventory = Inventory::default();
    ...
    #[test]
    fn test_add_item_into_inventory() {
        let mut inventory = Inventory::default();
        inventory
            .selected
            .iter_mut()
